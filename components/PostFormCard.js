    ...
    return(
       ...
       <div className="flex gap-2">
        ...
        <Link href={"/profile/"+profile?.id}>
          <Avatar url={profile?.avatar} /></Link>
        </div>
        {profile && (
...
<span className="hidden md:block">Photos</span></label>
</div>
...
<span className="hidden md:block">Mood</span></button>
                ...
                <div className="grow text-right">
                    <button onClick={createPost} className="bg-socialRed text-white px-6 py-1 rounded-md">Share</button>
                </div>
